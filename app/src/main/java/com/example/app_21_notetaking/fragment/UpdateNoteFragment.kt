...
import com.example.app_21_notetaking.databinding.FragmentUpdateNoteBinding
...
class UpdateNoteFragment : Fragment(R.layout.fragment_update_note) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.updateTitle.setText(currentNote.title)
        binding.updateBody.setText(currentNote.body)

        binding.fabDone.setOnClickListener{
            val title = binding.updateTitle.text.toString().trim()
            val body = binding.updateBody.text.toString().trim()
    ...
    private fun deleteNote(){
        AlertDialog.Builder(activity).apply {
            ...
            setPositiveButton("Delete"){
                ...
                Toast.makeText(
                    context,
                    "Note deleted successfully", Toast.LENGTH_SHORT
                ).show()
            }
